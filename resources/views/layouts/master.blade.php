			...
			<div class="container">
				...
				<nav class="main-menu">
					<ul class="l-inline ov">
						<li><a href="/lshop/public/index">Trang chủ</a></li>
						<li><a href="/lshop/public/product">Sản phẩm</a>
							<ul class="sub-menu">
								<li><a href="/lshop/public/type">Sản phẩm 1</a></li>
								<li><a href="/lshop/public/type">Sản phẩm 2</a></li>
								<li><a href="/lshop/public/type">Sản phẩm 4</a></li>
							</ul>
						</li>
						<li><a href="/lshop/public/about">Giới thiệu</a></li>
						<li><a href="/lshop/public/contact">Liên hệ</a></li>
					</ul>
					<div class="clearfix"></div>
				</nav>
			</div> <!-- .container -->
